...
def test_answers(filename, question, expected_answer, expected_dita_path, vectordb_manager, giga):
    try:
        ...
        log_result_to_csv(
            ...
            dita_path,
            rouge_metrics['rouge_1_recall'],
            rouge_metrics['rouge_1_precision'],
            rouge_metrics['rouge_1_f1'],
            rouge_metrics['rouge_2_recall'],
            rouge_metrics['rouge_2_precision'],
            rouge_metrics['rouge_2_f1'],
            rouge_metrics['rouge_l_recall'],
            rouge_metrics['rouge_l_precision'],
